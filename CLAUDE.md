...
```
# コミットメッセージ例
Add GitExecutor for repository operations

- Implement clone, commit, push, branch operations
- Add authentication support (SSH, password)
- Include comprehensive tests

# ステータス付きコミットメッセージ例
[WIP] Add issue-driven development samples

- sample_issue_feature.json: New feature pattern
- sample_issue_microservices.json: Microservices pattern
...
- PRタイトルは変更内容を簡潔に記述
- マージ時は `gh pr merge <番号> --merge` を使用
